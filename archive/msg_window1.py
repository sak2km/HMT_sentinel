...
class msg_window1(Frame):
    ...
    def entry_update(self, vehicle=None):
        ...
        self.txt_1.configure(text=self.sentinel_msg)
    ...
    def createWidgets(self):
        ...
        self.frame1 = Frame(self, bg='gray90', highlightbackground="gray90", highlightthickness=5, width=300, height=150, pady=5)
        ...
        self.txt_1 = Label(self.frame1, borderwidth=0,bg='gray90', font='Helvetica 18 bold',bd=0, width=50, height=15)
    ...
    def read_parameters(self):
        ...
        with open("scripts/parameters.txt") as f:
            for i, line in enumerate(f):
                if i==0:
                    if not line.startswith('function battery mission flight_time sentinel_msg'):
                        raise Exception('File is not supported WP version')
                else:
                    linearray=line.split('\t')
                    self.sentinel_msg=str(linearray[4])
